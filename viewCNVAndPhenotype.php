...
echo "<input type=\"text\" id=\"chromosome_1\" name=\"chromosome_1\" size=\"30\" value=\"" . $chromosome_1 . "\" style=\"margin-right:50px;\">";

echo "<label for=\"position_start_1\">Start:</label>";
echo "<input type=\"text\" id=\"position_start_1\" name=\"position_start_1\" size=\"30\" value=\"" . $position_start_1 . "\" style=\"margin-right:50px;\">";

echo "<label for=\"position_end_1\">End:</label>";
echo "<input type=\"text\" id=\"position_end_1\" name=\"position_end_1\" size=\"30\" value=\"" . $position_end_1 . "\" style=\"margin-right:50px;\">";

echo "<label for=\"cnv_data_option_1\"><b>Data Option:</b></label>";
echo "<select name=\"cnv_data_option_1\" id=\"cnv_data_option_1\" onchange=\"updateCNInAccordion()\">";
...
echo "</div>";
echo "<h3>CN</h3>";
echo "<div id=\"div_cn_in_accordion\">";
echo "</div>";
...
echo "<div id=\"CNV_and_Phenotye_detail_table\" style='width:auto; height:auto; overflow:scroll; max-height:1000px;'></div>";
